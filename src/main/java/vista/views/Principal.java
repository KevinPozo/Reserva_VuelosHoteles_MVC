...
public class Principal extends javax.swing.JPanel {
    ...
    private void siguienteBTNActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_siguienteBTNActionPerformed
        Dashboard.ShowPanel(new Principal2());
        Crud c = new Crud();
        List<Habitacion> lista;
        
        DefaultTableModel model = (DefaultTableModel) Principal2.jTableHabitaciones.getModel();
        
        try {
            c.obtenerHabitaciones().forEach(x -> model.addRow(new Object[]{x.getIdHabitacion(), x.getNombreHotel(), x.getTipoHabitacion(), x.getPrecioNoche()}));
